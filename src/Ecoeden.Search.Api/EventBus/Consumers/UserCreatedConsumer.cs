...
public class UserCreatedConsumer(ILogger logger,
    IMapper mapper,
...
) : IConsumer<UserCreated>
{
    ...
    public async Task Consume(ConsumeContext<UserCreated> context)
    {
        ...
        _logger.Here()
            ...
            .ForContext("Event", typeof(UserCreated).Name)
            .WithCorrelationId(context.Message.CorrelationId)
            .Information("Message processing started for the event {type}", typeof(UserCreated).Name);
